...
namespace Pulumi.Kubernetes.Helm.V3
{
    ...
    public sealed class Chart : CollectionComponentResource
    {
        ...
        private Output<ImmutableDictionary<string, KubernetesResource>> ParseTemplate(Union<ChartArgsUnwrap, LocalChartArgsUnwrap> args, string releaseName, ImmutableHashSet<Resource> dependsOn)
        {
            ...
            {
                var cfg = args.AsT0;
                ((BaseChartArgsUnwrap)cfg).ReleaseName = releaseName;
                jsonOpts = JsonSerializer.Serialize(cfg, serializeOptions);
                cfgBase = cfg;
            }
            else
            {
            ...
            return Invokes
                .HelmTemplate(new HelmTemplateArgs { JsonOpts = jsonOpts })
                .Apply(objs =>
                {
